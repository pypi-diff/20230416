# Comparing `tmp/pipen_diagram-0.4.0.tar.gz` & `tmp/pipen_diagram-0.5.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pipen_diagram-0.4.0.tar", max compression
+gzip compressed data, was "pipen_diagram-0.5.0.tar", max compression
```

## Comparing `pipen_diagram-0.4.0.tar` & `pipen_diagram-0.5.0.tar`

### file list

```diff
@@ -1,7 +1,7 @@
--rwxr-xr-x   0        0        0     1980 2023-03-29 21:03:46.756237 pipen_diagram-0.4.0/README.md
--rw-r--r--   0        0        0      147 2023-03-29 21:03:46.756237 pipen_diagram-0.4.0/pipen_diagram/__init__.py
--rw-r--r--   0        0        0     8716 2023-03-29 21:03:46.756237 pipen_diagram-0.4.0/pipen_diagram/diagram.py
--rw-r--r--   0        0        0     3553 2023-03-29 21:03:46.756237 pipen_diagram-0.4.0/pipen_diagram/entry.py
--rwxr-xr-x   0        0        0     1131 2023-03-29 21:03:46.756237 pipen_diagram-0.4.0/pyproject.toml
--rw-r--r--   0        0        0     2868 1970-01-01 00:00:00.000000 pipen_diagram-0.4.0/setup.py
--rw-r--r--   0        0        0     2704 1970-01-01 00:00:00.000000 pipen_diagram-0.4.0/PKG-INFO
...
### Comparing `pipen_diagram-0.4.0/README.md` & `pipen_diagram-0.5.0/README.md`

 * *Files identical despite different names*

### Comparing `pipen_diagram-0.4.0/pipen_diagram/diagram.py` & `pipen_diagram-0.5.0/pipen_diagram/diagram.py`

 * *Files identical despite different names*

### Comparing `pipen_diagram-0.4.0/pipen_diagram/entry.py` & `pipen_diagram-0.5.0/pipen_diagram/entry.py`

 * *Files identical despite different names*

### Comparing `pipen_diagram-0.4.0/pyproject.toml` & `pipen_diagram-0.5.0/pyproject.toml`
...
-addopts = "-vv -W error::UserWarning -p no:asyncio --cov-config=.coveragerc --cov=pipen_diagram --cov-report xml:.coverage.xml --cov-report term-missing"
...
### Comparing `pipen_diagram-0.4.0/setup.py` & `pipen_diagram-0.5.0/setup.py`
...
@@ -4,31 +4,31 @@
 ...
 install_requires = \
-['graphviz>=0.20,<0.21', 'pipen>=0.7,<0.8']
...
### Comparing `pipen_diagram-0.4.0/PKG-INFO` & `pipen_diagram-0.5.0/PKG-INFO`
