# Comparing `tmp/pip_and_pip_tools-6.13.0.tar.gz` & `tmp/pip_and_pip_tools-6.6.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pip_and_pip_tools-6.13.0.tar", last modified: Sun Apr 16 18:14:53 2023, max compression
+gzip compressed data, was "pip_and_pip_tools-6.6.2.tar", last modified: Fri May 27 18:47:29 2022, max compression
```

## Comparing `pip_and_pip_tools-6.13.0.tar` & `pip_and_pip_tools-6.6.2.tar`

### file list

```diff
@@ -1,7 +1,7 @@
--rw-r--r--   0        0        0      451 2023-04-16 18:14:39.955510 pip_and_pip_tools-6.13.0/.github/workflows/pypi.yml
--rw-r--r--   0        0        0        5 2023-04-16 18:14:39.955510 pip_and_pip_tools-6.13.0/.gitignore
--rw-r--r--   0        0        0      471 2023-04-16 18:14:39.955510 pip_and_pip_tools-6.13.0/LICENSE
--rw-r--r--   0        0        0     1622 2023-04-16 18:14:39.955510 pip_and_pip_tools-6.13.0/README.rst
--rw-r--r--   0        0        0        0 2023-04-16 18:14:39.955510 pip_and_pip_tools-6.13.0/pip_and_pip_tools/__init__.py
--rw-r--r--   0        0        0      469 2023-04-16 18:14:39.955510 pip_and_pip_tools-6.13.0/pyproject.toml
--rw-r--r--   0        0        0     1987 1970-01-01 00:00:00.000000 pip_and_pip_tools-6.13.0/PKG-INFO
...
### Comparing `pip_and_pip_tools-6.13.0/README.rst` & `pip_and_pip_tools-6.6.2/PKG-INFO`
...
### Comparing `pip_and_pip_tools-6.13.0/PKG-INFO` & `pip_and_pip_tools-6.6.2/README.rst`
...
-Description-Content-Type: text/x-rst
-Requires-Dist: pip
-Requires-Dist: pip-tools>=6.13.0
-Requires-Dist: flit<4 ; extra == "dev"
-Project-URL: Home, https://github.com/andydecleyre/pip-and-pip-tools
-Provides-Extra: dev
-
