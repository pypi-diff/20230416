# Comparing `tmp/frasa-0.1.51.tar.gz` & `tmp/frasa-0.1.52.tar.gz`
...
### Comparing `frasa-0.1.51/frasa/datasets/corpus/indonesia/lemma/dict.json` & `frasa-0.1.52/frasa/datasets/corpus/indonesia/lemma/dict.json`
